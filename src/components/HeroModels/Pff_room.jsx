...
Command: npx gltfjsx@6.5.3 pff_room.glb
...
export function PFFRoom(props) {
  const { nodes, materials } = useGLTF('/models/pff_room.glb')
  return (
...
useGLTF.preload('/models/pff_room.glb')
